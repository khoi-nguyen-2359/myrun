...
interface RouteTrackingState {
    ...
    suspend fun setStartLocation(location: akio.apps.myrun.data.location.api.model.Location)
    suspend fun getStartLocation(): akio.apps.myrun.data.location.api.model.Location?
